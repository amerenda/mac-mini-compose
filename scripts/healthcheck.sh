...
echo ""
check "BIND9 (10.100.20.18:53)"      "dig @10.100.20.18 amer.home SOA +short +time=2"
check "Pihole DNS (10.100.20.19:53)"  "dig @10.100.20.19 google.com +short +time=2"
check "Pihole Web (10.100.20.19:80)"  "curl -sf http://10.100.20.19/admin/ -o /dev/null"
